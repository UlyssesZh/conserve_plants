...
\begin{table}[h!]
  ...
  \begin{tabular}{cccc}
	...
	$\xi$ & $\mathbb N$ & & The project with longest duration in the plan\\
...
To measure how balanced the spent funds are distributed through time, the variance of yearly costs is defined.
...
The sum $c_x$ must converge because starting from 
