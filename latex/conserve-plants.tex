...
\end{assumption}
We don't consider the situation that different funds are raised in different years, which can help us have constraints seperately on different years.
It also constrainted that funds cannot overdraft from other years. 
\begin{assumption}
