...
To be specific, the problem is to reach the goal described in Section \ref{sec:goal} under the constraints described in Section \ref{sec:constraints}.
...
the plan only contains one project with the minimum $\frac{\varepsilon_x}{d_xc_x}$, which is not what we want to see.
...
Case 1: $\frac{\varepsilon_0}{c_0}\le\frac{\varepsilon_1}{c_1}$.

In this case,
\begin{equation*}
\frac{\varepsilon_0}{c_0}\le\frac{\varepsilon_0+\varepsilon_1}{c_0+c_1}\le\frac{\varepsilon_1}{c_1}.
\end{equation*}
Thus, if the plan consists of both the $2$ projects,
\begin{equation*}
\frac TC=\frac{\varepsilon_0+\varepsilon_1}{c_0+c_1}\cdot\frac1{d_1}\le\frac{\varepsilon_1}{c_1d_1}.
\end{equation*}
Therefore, the plan consisting of only project $1$ is better than that of both projects.

Case 2: $\frac{\varepsilon_0}{c_0}>\frac{\varepsilon_1}{c_1}$.

Similarly to case 1, in this case,
\begin{equation*}
\frac{\varepsilon_0}{c_0}>\frac{\varepsilon_0+\varepsilon_1}{c_0+c_1}>\frac{\varepsilon_1}{c_1}.
\end{equation*}
Thus, if the plan consists of both the $2$ projects,
\begin{equation*}
\frac TC=\frac{\varepsilon_0+\varepsilon_1}{c_0+c_1}\cdot\frac1{d_1}<\frac{\varepsilon_0}{c_0d_1}\le\frac{\varepsilon_0}{c_0d_0}.
\end{equation*}
...
The only constraint to the plan is due to the limitation of funds.
...
\begin{enumerate}
\item Choose proper projects to make the plan have the maximum $T$,
\item Decide the minimum funds to be raised to satisfy step 1 and the constraint (Equation \ref{eq:constraint}),
\item Decide the start time for each chosen project in step 1 to minimize the variance of yearly costs of the plan.
\end{enumerate}
